...
const formData = ref({
  id: props.pointure.id,
  label: props.pointure.label || ''
});

watch(() => props.pointure, (newValue) => {
  formData.value = {
    id: newValue.id,
      ...
      <div class="modal-body">
        <form @submit.prevent="submitForm">
          <div class="form-group">
            <label for="color-name">taille de la pointure</label>
            <input
              id="pointure-name"
              v-model="formData.label"
              type="text"
              placeholder="Entrez la pointure"
              required
            />
          </div>
